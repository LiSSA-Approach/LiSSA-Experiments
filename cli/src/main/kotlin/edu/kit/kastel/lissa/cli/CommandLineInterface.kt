...
val logger: Logger = LoggerFactory.getLogger("LiSSA-CLI")

fun main(args: Array<String>) {
    val parser = ArgParser("LiSSA-CLI")
    val inputOntology by parser.option(ArgType.String, shortName = "i", description = "Path to the Model Ontology")
        .required()
